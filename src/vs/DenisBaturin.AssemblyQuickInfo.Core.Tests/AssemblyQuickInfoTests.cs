...
namespace DenisBaturin.AssemblyQuickInfo.Core.Tests
{
        ...
        public static TheoryData<TestCaseItem> TestCases =
            new TheoryData<TestCaseItem>
            {
                new TestCaseItem($"{nameof(AssemblyQuickInfo.Name)}")
                {
                    ...
                    ExpectedPropertyValue = "DenisBaturin.AssemblyQuickInfo.Core.Tests"
                },
                new TestCaseItem("FullName")
                {
                    ActualPropertyValue = new AssemblyQuickInfo(Assembly.GetExecutingAssembly()).FullName,
                    ExpectedPropertyValue = "DenisBaturin.AssemblyQuickInfo.Core.Tests, Version=1.0.1.2, Culture=neutral, PublicKeyToken=null"
                },
                ...
                new TestCaseItem("Description")
                {
                    ...
                    ExpectedPropertyValue = "Tests (.NET Core) for DenisBaturin.AssemblyQuickInfo"
                },
                ...
                new TestCaseItem("Guid")
                {
                    ...
                    ExpectedPropertyValue = "b07da626-b1aa-4266-b65f-48e355f61a76"
                },
