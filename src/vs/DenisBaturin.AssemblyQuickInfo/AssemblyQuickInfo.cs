...
namespace DenisBaturin.AssemblyQuickInfo
{
    ...
    public class AssemblyQuickInfo
    {
        ...
        /// <summary>
        /// Returns string representation of the current System.Version object. A specified count indicates the number of components to return.
        /// </summary>
        ...
        public string NeutralResourcesLanguageCultureName => _assembly.GetCustomAttribute<NeutralResourcesLanguageAttribute>()?.CultureName;
        ...
        /// <returns>Directory information for assembly.</returns>
